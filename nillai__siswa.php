    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <foarm method="POST" action="index.php">
                    <div class="row">
                ...
                $ns1 = ['id'=>1, 'nama_lengkap' => 'Ahmad Zulfikar', 'nim'=>'011025', 'matkul' => 'Dasar - Dasar Pemrograman', 'nilai_uts'=>85, 'nilai_uas'=>84, 'nilai_tugas'=>78];
                $ns2 = ['id'=>2, 'nama_lengkap' => 'Ahmed Rosyi', 'nim'=>'01121', 'matkul' => 'Basis Data I', 'nilai_uts'=>79, 'nilai_uas'=>75, 'nilai_tugas'=>95];
                $ns3 = ['id'=>3, 'nama_lengkap' => 'Kayla Nazla', 'nim'=>'01130', 'matkul' => 'Pemrogrraman Web', 'nilai_uts'=>70, 'nilai_uas'=>86, 'nilai_tugas'=>70];
                $ns4 = ['id'=>4, 'nama_lengkap' => 'Arum Intan', 'nim'=>'01134', 'matkul' => 'Pemrograman Web', 'nilai_uts'=>90, 'nilai_uas'=>91, 'nilai_tugas'=>82];
            
                $ar_nilai = [$ns1, $ns2 , $ns3, $ns4];
                if (isset($_POST['proses'])) {
                    $ns5 = ['id' => 5, 'nama_lengkap' => $_POST['nama_lengkap'], 'nim' => $_POST['nim'], 'matkul' => $_POST['matkul'], 'nilai_uts' => $_POST['nilai_uts'], 'nilai_uas' => $_POST['nilai_uas'], 'nilai_tugas' => $_POST['nilai_tugas'], 'nilai akhir' => $_POST['nilai akhir']];
